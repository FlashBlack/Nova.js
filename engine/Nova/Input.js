define(['Nova/System'], function(System) {
	...
	Global.MouseGUI = new System.vector2();
	Global.Mouse = new System.vector2();
	Global.Mouse.Pressed = false;
	Global.Mouse.Down = false;
	Global.Mouse.Released = false;
	Global.Mouse.Moving = false;
	...
	Global.keyDown = function(key) {
	    if(typeof key === "number") key = charCodes[key];
	    if(keys[key]) return true;
	    return false;
	};
	
	Global.keyPressed = function(key) {
	    if(typeof key === "number") key = charCodes[key];
	    if(pressed[key]) return true;
	    return false;
	};
	
	Global.keyReleased = function(key) {
	    if(typeof key === "number") key = charCodes[key];
